...
This one adds a "lemonade" item. It acts as a potion that, when drunk, bestows
four health points.
...
our lemonade.json resource file, so we put that in 




define a proxy interface with
...
You can specify your Proxy as a class or interface, I prefer to use interfaces
with default no-op implementations for all of the classes.
